...
export default function AddReviewerForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['reviewer_name', 'email', 'password'];
    ...
    try {
      ...
      const response = await api.post('/reviewer/', {
      ...
      console.error('Error creating reviewer:', err.response?.data || err);
      setError(err.response?.data?.error || 'Failed to create reviewer');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="button-group">
          ...
          <Button 
            type="button" 
                onClick={() => navigate('/admin/reviewer')}
            variant="secondary"
          >
            Cancel
          </Button>
